...
1. Go to your GitHub repository: https://github.com/Aransyah28/Service-Big-Data
...
- The site will be available at: https://aransyah28.github.io/Service-Big-Data/
...
- `frontend/vite.config.js` - Vite configuration with base path set to `/Service-Big-Data/`

## Viewing Your Site

After the first successful deployment (which happens automatically after enabling GitHub Pages):
- Your site will be available at: **https://aransyah28.github.io/Service-Big-Data/**
